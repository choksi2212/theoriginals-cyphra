/* @ts-self-types="./cyphra_wasm.d.ts" */
 ...
 * @returns {Uint8Array}
 */
export function aes_gcm_decrypt(key_bytes, ciphertext_hex, nonce_hex) {
 ...
 * @returns {string}
 */
export function aes_gcm_encrypt(key_bytes, plaintext) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passArray8ToWasm0(key_bytes, wasm.__wbindgen_malloc);
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.aes_gcm_encrypt(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @returns {string}
 */
export function cyphra_wasm_version() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.cyphra_wasm_version();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
 ...
 * @returns {string}
 */
export function ed25519_sign(signing_key_hex, message) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(signing_key_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {boolean}
 */
export function ed25519_verify(verifying_key_hex, message, signature_hex) {
 ...
 * @returns {string}
 */
export function hkdf_sha256(ikm, salt, info, output_len) {
    let deferred5_0;
    let deferred5_1;
    try {
        ...
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.hkdf_sha256(ptr0, len0, ptr1, len1, ptr2, len2, output_len);
        var ptr4 = ret[0];
        var len4 = ret[1];
        if (ret[3]) {
            ptr4 = 0; len4 = 0;
 ...
 * @param {string} chain_key_hex
 * @returns {string}
 */
export function ratchet_chain_step(chain_key_hex) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(chain_key_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.ratchet_chain_step(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @param {string} dh_shared_hex
 * @param {string} prev_root_key_hex
 * @returns {string}
 */
export function ratchet_init_from_dh(dh_shared_hex, prev_root_key_hex) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(dh_shared_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(prev_root_key_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.ratchet_init_from_dh(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @returns {string}
 */
export function x25519_diffie_hellman(private_key_hex, peer_public_key_hex) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(private_key_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(peer_public_key_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('cyphra_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
