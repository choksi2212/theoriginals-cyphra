"""
Dataset Combination Script - PART 1 (Memory Optimized)
Processes ISCXVPN2016 and UNSW-NB15 datasets
...
# Part 1 Datasets (smaller ones first) - Use relative paths or raw strings
DATASETS_PART1 = [
...
def detect_label_column(df):
    ...
    label_candidates = ['label', 'Label', 'attack_cat', 'Attack', 'class', 'Class', 'category']
...
def load_file_with_chunks(file_path, dataset_info):
    ...
    try:
        if file_path.suffix.lower() == '.csv':
            ...
            # Load parquet (already optimized for memory)
...
def harmonize_columns(df, dataset_name):
    ...
    column_mappings = {
        ...
        'sloss': 'src_loss',
        'dloss': 'dst_loss',
        'sinpkt': 'src_inter_packet_time',
        'dinpkt': 'dst_inter_packet_time',
        
        # ISCXVPN2016 specific mappings
...
def main():
    ...
    print("=" * 70)
    print("🔥 DATASET COMBINATION - PART 1 (Memory Optimized)")
    print("=" * 70)
    ...
    print(f"✓ Features: {len(combined_part1.columns) - 5}")  # Exclude labels and dataset info
    
    # Save combined Part 1
